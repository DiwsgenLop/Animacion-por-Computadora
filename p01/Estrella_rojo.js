...
function createStar(gl) {
    ...
    var verts = [
     ...
     1.2,0.2,0.0,   //J
     0.4,0.4,0.0,   //K
     0,1.2,0.0,     //Se repite B para completar la figura
    ];
    gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(verts), gl.STATIC_DRAW);
    var star = {buffer:vertexBuffer, vertSize:3, nVerts:12, primtype:gl.TRIANGLE_FAN};
    return star;
}
